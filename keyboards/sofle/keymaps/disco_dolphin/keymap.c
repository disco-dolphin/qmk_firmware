...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *            `----------------------------------'            '------''---------------------------'
     */
    [_SYMBOL] = LAYOUT(_______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, _______, KC_ASTERISK, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, _______, KC_PLUS, KC_COLN, KC_MINUS, KC_DQT, KC_SCLN, KC_QUES, KC_EXCLAIM, KC_COMMA, KC_EQUAL, KC_LPRN, KC_RPRN, KC_AT, KC_QUOT, KC_PIPE, KC_AMPR, KC_LABK, KC_RABK, KC_DOLLAR, _______, _______, KC_HASH, KC_UNDS, KC_LBRC, KC_RBRC, KC_TILD, KC_BSLS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
