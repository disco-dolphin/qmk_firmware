...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *            `----------------------------------'            '------''---------------------------'
     */
    [_COMMON] = LAYOUT(KC_F11, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_F12, KC_ESC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BSPC, KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT, KC_TAB, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MUTE, XXXXXXX, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, KC_GRV, KC_SLSH, KC_LGUI, KC_LALT, KC_LCTL, MO(_SYMBOL), KC_ENT, KC_SPC, MO(_ACTION), KC_RCTL, KC_RALT, KC_RGUI),
    ...
    [_QWERTY] = LAYOUT(_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, _______, _______, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_DOT, _______, _______, KC_Z, KC_X, KC_C, KC_V, KC_B, _______, _______, KC_N, KC_M, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
    ...
    [_COLEMAK] = LAYOUT(_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_Q, KC_W, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Y, KC_DOT, _______, _______, KC_A, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_O, _______, _______, KC_Z, KC_X, KC_C, KC_D, KC_V, _______, _______, KC_K, KC_H, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
     ...
     *            `----------------------------------'            '------''---------------------------'
     */
    [_SYMBOL] = LAYOUT(_______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, _______, _______, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, _______, KC_ASTR, KC_MINUS, KC_PLUS, KC_DQT, KC_SCLN, KC_QUES, KC_EXCLAIM, KC_COMMA, KC_EQUAL, KC_LPRN, KC_RPRN, KC_AT, KC_QUOT, KC_PIPE, KC_AMPR, KC_LABK, KC_RABK, KC_DOLLAR, _______, _______, KC_HASH, KC_UNDS, KC_LBRC, KC_RBRC, KC_TILD, KC_BSLS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),

    /* ACTION
     * ,----------------------------------------.                     ,-----------------------------------------.
     * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |      | ---- | ---- | ---- | ---- | ---- |                    | Pgup | PWrd |  Up  | NWrd | DLine|      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |      | ---- | ---- | ---- | ---- | Caps |-------.    ,-------| Pgdn | Left | Down | Rigth|  Del |      |
     * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
     * |      | ---- | ---- | ---- | ---- | ---- |-------|    |-------| ---- | Home | ---- | End  | ---- |      |
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            |      |      |      |      | /       /       \      \  |      |      |      |      |
     ...
     *            `----------------------------------'            '------''---------------------------'
     */
    [_ACTION] = LAYOUT(_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGUP, C(KC_LEFT), KC_UP, C(KC_RIGHT), C(KC_BSPC), _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_CAPS, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, KC_HOME, XXXXXXX, KC_END, XXXXXXX, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______),
